            ...
            _this = {
            	...
            	toggle: function(e) {
            		...
            		if (_this.on) {
			            ...
			            (("Info" in window) && Info || console).log('Code chạy ngon...');
			        } else {
			            ...
			            (("Info" in window) && Info || console).log('Code chạy không ngon...');
			        }
			        _this.on=!_this.on;
                ...
                onKeyDown: function (e) {
                    ...
                    sm.speedX = (ek in {37:0}?2:(ek in {39:0}?-2:0 ) );
                    sm.speedY = (ek in {38:0}?1:(ek in {40:0}?-1:(ek in {33:0}? (so=Math.sqrt(Math.sqrt(wh)))*Math.sqrt(so/3)-4 :(ek in {34:0}? -(so=Math.sqrt(Math.sqrt(wh)))*Math.sqrt(so/3)+4 :(ek in {35:0}?-88:(ek in {36:0}?88:0) ) ) ) ) );

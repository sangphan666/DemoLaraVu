...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat|Oswald|Yanone+Kaffeesatz&display=swap" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('admins') }}/assets/js/login.js"></script>
</body>
</html>

...
use JPTech\Category\Repository\Requests\CreateCategoriesRequest;
...
class CategoriesRepository extends BaseRepository implements CategoriesRepositoryInterface
{
     ...
     */
    public function __construct(Category $model, Slug $model_slug, Content $model_content, SlugRepositoryInterface $slugsRepository, ContentRepositoryInterface $contentRepository)
    {
    ...
    private function checkValidation($category)
    {
        $rules= [
        ...
        $validator = Validator::make($category->all(), $rules, $messages);
        return $validator ;
    }
